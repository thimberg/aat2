...
000000                                  INVALID CONTINUE .                      
           DISPLAY "--After --LINE:440--  ‚g‚b‚g‚m”N“x = " ‚g‚b‚g‚m”N“x UPON CONSOLE
           DISPLAY "--After --LINE:441--  ‚g‚b‚g‚m”Ì”„ƒ`ƒƒƒlƒ‹ = " ‚g‚b‚g‚m”Ì”„ƒ`ƒƒƒlƒ‹ UPON CONSOLE
000000     IF NOT(FL-STS1 = "00") GO TO CX00052.                                 
           DISPLAY "--Before --LINE:443--  ‚g‚b‚g‚m”„ã‹àŠz = " ‚g‚b‚g‚m”„ã‹àŠz UPON CONSOLE
000000     COMPUTE ‚g‚b‚g‚m”„ã‹àŠz = ‚g‚b‚g‚m”„ã‹àŠz + ‚v‚j|”„ã‹àŠz                                
000000           REWRITE “ú•Ê”Ì”„‚b‚g•Ê”„ã—ÝŒv‚q ,                                         
000000                                    INVALID CONTINUE .                    
           DISPLAY "--After --LINE:447--  ‚g‚b‚g‚m”„ã‹àŠz = " ‚g‚b‚g‚m”„ã‹àŠz UPON CONSOLE
...
000000 CX00052. IF NOT(FL-STS1 = "23") GO TO CX00055.                            
           DISPLAY "--Before --LINE:455--  ‚g‚b‚g‚m”N“x = " ‚g‚b‚g‚m”N“x UPON CONSOLE
           DISPLAY "--Before --LINE:456--  ‚g‚b‚g‚m”Ì”„ƒ`ƒƒƒlƒ‹ = " ‚g‚b‚g‚m”Ì”„ƒ`ƒƒƒlƒ‹ UPON CONSOLE
           DISPLAY "--Before --LINE:457--  ‚g‚b‚g‚m”„ã‹àŠz = " ‚g‚b‚g‚m”„ã‹àŠz UPON CONSOLE
           DISPLAY "--Before --LINE:458--  ‚g‚b‚g‚m—\”õ = " ‚g‚b‚g‚m—\”õ UPON CONSOLE
000000     MOVE ‚v‚j|”N“x TO ‚g‚b‚g‚m”N“x                                                 
000000     MOVE ‚f‚x‚r‚`”Ì”„ƒ`ƒƒƒlƒ‹ƒR[ƒh TO ‚g‚b‚g‚m”Ì”„ƒ`ƒƒƒlƒ‹                                     
000000     MOVE ‚v‚j|ƒQ[ƒ€‚h‚c TO ‚g‚b‚g‚mƒQ[ƒ€‚h‚c                                           
...
000000                                    INVALID CONTINUE .                    
           DISPLAY "--After --LINE:466--  ‚g‚b‚g‚m”N“x = " ‚g‚b‚g‚m”N“x UPON CONSOLE
           DISPLAY "--After --LINE:467--  ‚g‚b‚g‚m”Ì”„ƒ`ƒƒƒlƒ‹ = " ‚g‚b‚g‚m”Ì”„ƒ`ƒƒƒlƒ‹ UPON CONSOLE
           DISPLAY "--After --LINE:468--  ‚g‚b‚g‚m”„ã‹àŠz = " ‚g‚b‚g‚m”„ã‹àŠz UPON CONSOLE
           DISPLAY "--After --LINE:469--  ‚g‚b‚g‚m—\”õ = " ‚g‚b‚g‚m—\”õ UPON CONSOLE
...
000000     IF NOT(‚d‚m‚c|”„ã‚v‚e = 0) GO TO CX00071.                                   
           DISPLAY "--Before --LINE:554--  ‚g‚b‚g‚m”N“x = " ‚g‚b‚g‚m”N“x UPON CONSOLE
           DISPLAY "--Before --LINE:555--  ‚g‚b‚g‚m”Ì”„ƒ`ƒƒƒlƒ‹ = " ‚g‚b‚g‚m”Ì”„ƒ`ƒƒƒlƒ‹ UPON CONSOLE
           DISPLAY "--Before --LINE:556--  ‚g‚b‚g‚mƒQ[ƒ€ƒ^ƒCƒv = " ‚g‚b‚g‚mƒQ[ƒ€ƒ^ƒCƒv UPON CONSOLE
           DISPLAY "--Before --LINE:557--  ‚g‚b‚g‚mƒuƒƒbƒNƒR[ƒh = " ‚g‚b‚g‚mƒuƒƒbƒNƒR[ƒh UPON CONSOLE
           DISPLAY "--Before --LINE:558--  ‚g‚b‚g‚m‰ñ† = " ‚g‚b‚g‚m‰ñ† UPON CONSOLE
           DISPLAY "--Before --LINE:559--  ‚g‚b‚g‚m”„ã‹àŠz = " ‚g‚b‚g‚m”„ã‹àŠz UPON CONSOLE
...
000000     MOVE ‚g‚b‚g‚m”„ã‹àŠz TO ‚s—ÝŒv”„ã‹àŠz (‚b‚m‚s|”„ã‚s‚a‚k) .                               
           DISPLAY "--After --LINE:571--  ‚g‚b‚g‚m”N“x = " ‚g‚b‚g‚m”N“x UPON CONSOLE
           DISPLAY "--After --LINE:572--  ‚g‚b‚g‚m”Ì”„ƒ`ƒƒƒlƒ‹ = " ‚g‚b‚g‚m”Ì”„ƒ`ƒƒƒlƒ‹ UPON CONSOLE
           DISPLAY "--After --LINE:573--  ‚g‚b‚g‚mƒQ[ƒ€ƒ^ƒCƒv = " ‚g‚b‚g‚mƒQ[ƒ€ƒ^ƒCƒv UPON CONSOLE
           DISPLAY "--After --LINE:574--  ‚g‚b‚g‚mƒuƒƒbƒNƒR[ƒh = " ‚g‚b‚g‚mƒuƒƒbƒNƒR[ƒh UPON CONSOLE
           DISPLAY "--After --LINE:575--  ‚g‚b‚g‚m‰ñ† = " ‚g‚b‚g‚m‰ñ† UPON CONSOLE
           DISPLAY "--After --LINE:576--  ‚g‚b‚g‚m”„ã‹àŠz = " ‚g‚b‚g‚m”„ã‹àŠz UPON CONSOLE
000000 CX00071.                                                                 
...
000000     ) GO TO CX00075.                                                      
           DISPLAY "--Before --LINE:600--  ‚b‚g‚t‚q”N“x = " ‚b‚g‚t‚q”N“x UPON CONSOLE
           DISPLAY "--Before --LINE:601--  ‚b‚g‚t‚q”Ì”„ƒ`ƒƒƒlƒ‹ƒR[ƒh = " ‚b‚g‚t‚q”Ì”„ƒ`ƒƒƒlƒ‹ƒR[ƒh UPON CONSOLE
...
000000             READ ”Ì”„ƒ`ƒƒƒlƒ‹•Ê”„ã—ÝŒv‚e INVALID CONTINUE.                          
           DISPLAY "--After --LINE:606--  ‚b‚g‚t‚q”N“x = " ‚b‚g‚t‚q”N“x UPON CONSOLE
           DISPLAY "--After --LINE:607--  ‚b‚g‚t‚q”Ì”„ƒ`ƒƒƒlƒ‹ƒR[ƒh = " ‚b‚g‚t‚q”Ì”„ƒ`ƒƒƒlƒ‹ƒR[ƒh UPON CONSOLE
000000     IF NOT(FL-STS1 = "00") GO TO CX00076.                                 
           DISPLAY "--Before --LINE:609--  ‚b‚g‚t‚q”„ã‹àŠz = " ‚b‚g‚t‚q”„ã‹àŠz UPON CONSOLE
000000     COMPUTE ‚b‚g‚t‚q”„ã‹àŠz = ‚b‚g‚t‚q”„ã‹àŠz + 
           ‚s—ÝŒv”„ã‹àŠz (‚b‚m‚s|”„ã‚s‚a‚k)                    
000000                 REWRITE ”Ì”„ƒ`ƒƒƒlƒ‹•Ê”„ã—ÝŒv‚q ,                                   
000000                                     INVALID CONTINUE .                   
           DISPLAY "--After --LINE:614--  ‚b‚g‚t‚q”„ã‹àŠz = " ‚b‚g‚t‚q”„ã‹àŠz UPON CONSOLE
...
000000 CX00076. IF NOT(FL-STS1 = "23") GO TO CX00079.                            
           DISPLAY "--Before --LINE:622--  ‚b‚g‚t‚q”N“x = " ‚b‚g‚t‚q”N“x UPON CONSOLE
           DISPLAY "--Before --LINE:623--  ‚b‚g‚t‚q”Ì”„ƒ`ƒƒƒlƒ‹ƒR[ƒh = " ‚b‚g‚t‚q”Ì”„ƒ`ƒƒƒlƒ‹ƒR[ƒh UPON CONSOLE
           DISPLAY "--Before --LINE:624--  ‚b‚g‚t‚q”„ã‹àŠz = " ‚b‚g‚t‚q”„ã‹àŠz UPON CONSOLE
000000     MOVE ‚s—ÝŒv”N“x (‚b‚m‚s|”„ã‚s‚a‚k) TO ‚b‚g‚t‚q”N“x                                     
000000     MOVE ‚s—ÝŒv”Ì”„ƒ`ƒƒƒlƒ‹ (‚b‚m‚s|”„ã‚s‚a‚k) TO 
           ‚b‚g‚t‚q”Ì”„ƒ`ƒƒƒlƒ‹ƒR[ƒh                          
000000     MOVE ‚s—ÝŒv”„ã‹àŠz (‚b‚m‚s|”„ã‚s‚a‚k) TO ‚b‚g‚t‚q”„ã‹àŠz                                 
000000                 WRITE ”Ì”„ƒ`ƒƒƒlƒ‹•Ê”„ã—ÝŒv‚q INVALID CONTINUE.                     
           DISPLAY "--After --LINE:630--  ‚b‚g‚t‚q”N“x = " ‚b‚g‚t‚q”N“x UPON CONSOLE
           DISPLAY "--After --LINE:631--  ‚b‚g‚t‚q”Ì”„ƒ`ƒƒƒlƒ‹ƒR[ƒh = " ‚b‚g‚t‚q”Ì”„ƒ`ƒƒƒlƒ‹ƒR[ƒh UPON CONSOLE
           DISPLAY "--After --LINE:632--  ‚b‚g‚t‚q”„ã‹àŠz = " ‚b‚g‚t‚q”„ã‹àŠz UPON CONSOLE
...
000000 CX00085.                                                                 
           DISPLAY "--Before --LINE:685--  ‚g‚b‚g‚m”N“x = " ‚g‚b‚g‚m”N“x UPON CONSOLE
           DISPLAY "--Before --LINE:686--  ‚g‚b‚g‚m”Ì”„ƒ`ƒƒƒlƒ‹ = " ‚g‚b‚g‚m”Ì”„ƒ`ƒƒƒlƒ‹ UPON CONSOLE
           DISPLAY "--Before --LINE:687--  ‚g‚b‚g‚mƒQ[ƒ€ƒ^ƒCƒv = " ‚g‚b‚g‚mƒQ[ƒ€ƒ^ƒCƒv UPON CONSOLE
           DISPLAY "--Before --LINE:688--  ‚g‚b‚g‚mƒuƒƒbƒNƒR[ƒh = " ‚g‚b‚g‚mƒuƒƒbƒNƒR[ƒh UPON CONSOLE
           DISPLAY "--Before --LINE:689--  ‚g‚b‚g‚m‰ñ† = " ‚g‚b‚g‚m‰ñ† UPON CONSOLE
           DISPLAY "--Before --LINE:690--  ‚g‚b‚g‚m”„ã‹àŠz = " ‚g‚b‚g‚m”„ã‹àŠz UPON CONSOLE
...
000000           WRITE “ú•Ê”Ì”„‚b‚g•Ê”„ã—ÝŒv‚q INVALID CONTINUE.                           
           DISPLAY "--After --LINE:701--  ‚g‚b‚g‚m”N“x = " ‚g‚b‚g‚m”N“x UPON CONSOLE
           DISPLAY "--After --LINE:702--  ‚g‚b‚g‚m”Ì”„ƒ`ƒƒƒlƒ‹ = " ‚g‚b‚g‚m”Ì”„ƒ`ƒƒƒlƒ‹ UPON CONSOLE
           DISPLAY "--After --LINE:703--  ‚g‚b‚g‚mƒQ[ƒ€ƒ^ƒCƒv = " ‚g‚b‚g‚mƒQ[ƒ€ƒ^ƒCƒv UPON CONSOLE
           DISPLAY "--After --LINE:704--  ‚g‚b‚g‚mƒuƒƒbƒNƒR[ƒh = " ‚g‚b‚g‚mƒuƒƒbƒNƒR[ƒh UPON CONSOLE
           DISPLAY "--After --LINE:705--  ‚g‚b‚g‚m‰ñ† = " ‚g‚b‚g‚m‰ñ† UPON CONSOLE
           DISPLAY "--After --LINE:706--  ‚g‚b‚g‚m”„ã‹àŠz = " ‚g‚b‚g‚m”„ã‹àŠz UPON CONSOLE
