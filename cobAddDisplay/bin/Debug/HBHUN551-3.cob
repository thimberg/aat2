...
000000     MOVE ‚v‚j|ƒQ[ƒ€‚h‚c TO ‚g‚b‚g‚mƒQ[ƒ€‚h‚c                                           
               DISPLAY "‚g‚b‚g‚mƒQ[ƒ€ƒ^ƒCƒv = " ‚g‚b‚g‚mƒQ[ƒ€ƒ^ƒCƒv
000000         READ  “ú•Ê”Ì”„‚b‚g•Ê”„ã—ÝŒv‚e ,                                             
000000                                  INVALID CONTINUE .                      
000000     IF NOT(FL-STS1 = "00") GO TO CX00052.                                 
           DISPLAY "‘O‚g‚b‚g‚m”„ã‹àŠz = " ‚g‚b‚g‚m”„ã‹àŠz UPON CONSOLE
           DISPLAY "‚v‚j|”„ã‹àŠz = " ‚v‚j|”„ã‹àŠz UPON CONSOLE
000000     COMPUTE ‚g‚b‚g‚m”„ã‹àŠz = ‚g‚b‚g‚m”„ã‹àŠz + ‚v‚j|”„ã‹àŠz                                
           DISPLAY "Œã‚g‚b‚g‚m”„ã‹àŠz = " ‚g‚b‚g‚m”„ã‹àŠz UPON CONSOLE
...
000000                       FL-STS1 " " FL-STS2                                
000000             STOP RUN .                                                 
           DISPLAY "--Before --LINE:533--  CX00053" UPON CONSOLE
000000 CX00053.                                                                 
           DISPLAY "--After --LINE:535--  CX00053" UPON CONSOLE
000000     GO TO CX00054.                                                       
           DISPLAY "--Before --LINE:537--  CX00052" UPON CONSOLE
000000 CX00052. IF NOT(FL-STS1 = "23") GO TO CX00055.                            
           DISPLAY "--After --LINE:539--  CX00052" UPON CONSOLE
000000     MOVE ‚v‚j|”N“x TO ‚g‚b‚g‚m”N“x                                                 
000000     MOVE ‚f‚x‚r‚`”Ì”„ƒ`ƒƒƒlƒ‹ƒR[ƒh TO ‚g‚b‚g‚m”Ì”„ƒ`ƒƒƒlƒ‹                                     
000000     MOVE ‚v‚j|ƒQ[ƒ€‚h‚c TO ‚g‚b‚g‚mƒQ[ƒ€‚h‚c                                           
...
000000                                    INVALID CONTINUE .                    
               DISPLAY "WRITE" UPON CONSOLE
000000     IF NOT(FL-STS1 NOT = "00") GO TO CX00056.                             
000000             DISPLAY "HBHUN551-27 VIHCHNUR WRITE ERROR ",                 
000000                       FL-STS1 " " FL-STS2                                
000000             STOP RUN .                                                 
           DISPLAY "--Before --LINE:552--  CX00056" UPON CONSOLE
000000 CX00056.                                                                 
           DISPLAY "--After --LINE:554--  CX00056" UPON CONSOLE
000000     GO TO CX00054.                                                       
           DISPLAY "--Before --LINE:556--  CX00055" UPON CONSOLE
000000 CX00055.                                                                 
           DISPLAY "--After --LINE:558--  CX00055" UPON CONSOLE
000000           DISPLAY "HBHUN551-28 VIHCHNUR READ ERROR ",                    
000000                     FL-STS1 " " FL-STS2                                  
000000           STOP RUN .                                                   
           DISPLAY "--Before --LINE:562--  CX00054" UPON CONSOLE
000000 CX00054.                                                                 
           DISPLAY "--After --LINE:564--  CX00054" UPON CONSOLE
000000     COMPUTE CNT-COMMIT = CNT-COMMIT + 1 .                                
000000     IF NOT(•Ï”‚b‚n‚l‚l‚h‚sŒ” < CNT-COMMIT) GO TO CX00057.                        
000000           COMMIT                                                         
000000     MOVE 0 TO CNT-COMMIT .                                               
           DISPLAY "--Before --LINE:569--  CX00057" UPON CONSOLE
000000 CX00057.                                                                 
           DISPLAY "--After --LINE:571--  CX00057" UPON CONSOLE
000000     COMPUTE CNT-COMMIT = CNT-COMMIT + 1 .                                
000000     IF NOT(•Ï”‚b‚n‚l‚l‚h‚sŒ” < CNT-COMMIT) GO TO CX00058.                        
000000           COMMIT                                                         
000000     MOVE 0 TO CNT-COMMIT .                                               
           DISPLAY "--Before --LINE:576--  CX00058" UPON CONSOLE
000000 CX00058.                                                                 
           DISPLAY "--After --LINE:578--  CX00058" UPON CONSOLE
000000     MOVE ‚v‚t‚a‚t”„êƒR[ƒh TO ‚v‚j|”„êƒR[ƒh                                           
000000     MOVE ‚v‚t‚a‚tƒQ[ƒ€‚h‚c TO ‚v‚j|ƒQ[ƒ€‚h‚c                                           
000000     MOVE 0 TO ‚v‚j|”„ã‹àŠz .                                                  
000000     GO TO CX00039.                                                       
           DISPLAY "--Before --LINE:583--  CX00040" UPON CONSOLE
000000 CX00040.                                                                 
           DISPLAY "--After --LINE:585--  CX00040" UPON CONSOLE
000000 CX00005. EXIT.                                                           
000000 P200-RTN .                                                               
...
000000     GO TO CX00060.                                                       
           DISPLAY "--Before --LINE:592--  CX00059" UPON CONSOLE
000000 CX00059.                                                                 
           DISPLAY "--After --LINE:594--  CX00059" UPON CONSOLE
000000     MOVE 2 TO SUK-RKEY .                                                 
           DISPLAY "--Before --LINE:596--  CX00060" UPON CONSOLE
000000 CX00060.                                                                 
           DISPLAY "--After --LINE:598--  CX00060" UPON CONSOLE
...
000000                     FL-STS1 " " FL-STS2                                  
000000         STOP RUN .                                                     
           DISPLAY "--Before --LINE:604--  CX00061" UPON CONSOLE
000000 CX00061.                                                                 
           DISPLAY "--After --LINE:606--  CX00061" UPON CONSOLE
000000     MOVE 0 TO ‚d‚m‚c|ƒQ[ƒ€I—¹ó‘Ô .                                              
000000     MOVE 1 TO ‚b‚m‚sƒQ[ƒ€I—¹ó‘Ô .                                               
           DISPLAY "--Before --LINE:609--  CX00062" UPON CONSOLE
000000 CX00062. IF NOT( (‚d‚m‚c|ƒQ[ƒ€I—¹ó‘Ô = 0) AND 
            (‚b‚m‚sƒQ[ƒ€I—¹ó‘Ô <= 90)                
000000     ) GO TO CX00063.                                                      
           DISPLAY "--After --LINE:613--  CX00062" UPON CONSOLE
...
000000     GO TO CX00065.                                                       
           DISPLAY "--Before --LINE:621--  CX00064" UPON CONSOLE
000000 CX00064.                                                                 
           DISPLAY "--After --LINE:623--  CX00064" UPON CONSOLE
000000     IF NOT(‚r‚t‚j‚P‚f•Ê’Š‚¹‚ñ‘ÎÛ‚r (‚b‚m‚sƒQ[ƒ€I—¹ó‘Ô) = 
           1) GO TO CX00066.                  
000000     PERFORM P220-RTN THRU CX00008 .                                      
           DISPLAY "--Before --LINE:627--  CX00066" UPON CONSOLE
000000 CX00066.                                                                 
           DISPLAY "--After --LINE:629--  CX00066" UPON CONSOLE
           DISPLAY "--Before --LINE:630--  CX00065" UPON CONSOLE
000000 CX00065.                                                                 
           DISPLAY "--After --LINE:632--  CX00065" UPON CONSOLE
000000     COMPUTE ‚b‚m‚sƒQ[ƒ€I—¹ó‘Ô = ‚b‚m‚sƒQ[ƒ€I—¹ó‘Ô + 1 .                                
000000     GO TO CX00062.                                                       
           DISPLAY "--Before --LINE:635--  CX00063" UPON CONSOLE
000000 CX00063.                                                                 
           DISPLAY "--After --LINE:637--  CX00063" UPON CONSOLE
000000 CX00006. EXIT.                                                           
000000 P210-RTN .                                                               
000000     MOVE 0 TO ‚d‚m‚c|”„ã‚v‚e .                                                 
...
000000                       FL-STS1 " " FL-STS2                                
000000           STOP RUN .                                                   
           DISPLAY "--Before --LINE:650--  CX00067" UPON CONSOLE
000000 CX00067.                                                                 
           DISPLAY "--After --LINE:652--  CX00067" UPON CONSOLE
           DISPLAY "--Before --LINE:653--  CX00068" UPON CONSOLE
000000 CX00068. IF NOT(‚d‚m‚c|”„ã‚v‚e = 0) GO TO CX00069.                              
           DISPLAY "--After --LINE:655--  CX00068" UPON CONSOLE
...
000000                            FL-STS1 " " FL-STS2.                          
000000           STOP RUN .                                                   
           DISPLAY "--Before --LINE:662--  CX00070" UPON CONSOLE
000000 CX00070.                                                                 
           DISPLAY "--After --LINE:664--  CX00070" UPON CONSOLE
...
000000     MOVE ‚g‚b‚g‚m‰ñ† TO 
           ...
           DISPLAY "‚g‚b‚g‚m”„ã‹àŠz = " ‚g‚b‚g‚m”„ã‹àŠz
000000     MOVE ‚g‚b‚g‚m”„ã‹àŠz TO ‚s—ÝŒv”„ã‹àŠz (‚b‚m‚s|”„ã‚s‚a‚k) .                               
           DISPLAY "--Before --LINE:678--  CX00071" UPON CONSOLE
000000 CX00071.                                                                 
           DISPLAY "--After --LINE:680--  CX00071" UPON CONSOLE
000000     GO TO CX00068.                                                       
           DISPLAY "--Before --LINE:682--  CX00069" UPON CONSOLE
000000 CX00069.                                                                 
           DISPLAY "--After --LINE:684--  CX00069" UPON CONSOLE
...
000000                          FL-STS1 " " FL-STS2.                            
000000         STOP RUN .                                                     
           DISPLAY "--Before --LINE:695--  CX00072" UPON CONSOLE
000000 CX00072.                                                                 
           DISPLAY "--After --LINE:697--  CX00072" UPON CONSOLE
000000 CX00007. EXIT.                                                           
000000 P220-RTN .                                                               
000000     MOVE 1 TO ‚b‚m‚s|”„ã‚s‚a‚k                                                  
000000     MOVE ZERO TO CNT-COMMIT .                                            
           DISPLAY "--Before --LINE:702--  CX00073" UPON CONSOLE
000000 CX00073. IF NOT(‚b‚m‚s|”„ã‚s‚a‚k <= 
           ‚v‚j|”„ã‚s‚a‚k) GO TO CX00074.                     
           DISPLAY "--After --LINE:705--  CX00073" UPON CONSOLE
...
000000     IF NOT(FL-STS1 = "00") GO TO CX00076.                                 
           DISPLAY "‘O@@@‚b‚g‚t‚q”„ã‹àŠz = " ‚b‚g‚t‚q”„ã‹àŠz
           DISPLAY "‚s—ÝŒv”„ã‹àŠz = " ‚s—ÝŒv”„ã‹àŠz (‚b‚m‚s|”„ã‚s‚a‚k)
000000     COMPUTE ‚b‚g‚t‚q”„ã‹àŠz = ‚b‚g‚t‚q”„ã‹àŠz + 
           ‚s—ÝŒv”„ã‹àŠz (‚b‚m‚s|”„ã‚s‚a‚k)                    
           DISPLAY "Œã@@@‚b‚g‚t‚q”„ã‹àŠz = " ‚b‚g‚t‚q”„ã‹àŠz
...
000000                   STOP RUN .                                           
           DISPLAY "--Before --LINE:725--  CX00077" UPON CONSOLE
000000 CX00077.                                                                 
           DISPLAY "--After --LINE:727--  CX00077" UPON CONSOLE
000000     GO TO CX00078.                                                       
           DISPLAY "--Before --LINE:729--  CX00076" UPON CONSOLE
000000 CX00076. IF NOT(FL-STS1 = "23") GO TO CX00079.                            
           DISPLAY "--After --LINE:731--  CX00076" UPON CONSOLE
000000     MOVE ‚s—ÝŒv”N“x (‚b‚m‚s|”„ã‚s‚a‚k) TO ‚b‚g‚t‚q”N“x                                     
000000     MOVE ‚s—ÝŒv”Ì”„ƒ`ƒƒƒlƒ‹ (‚b‚m‚s|”„ã‚s‚a‚k) TO 
           ‚b‚g‚t‚q”Ì”„ƒ`ƒƒƒlƒ‹ƒR[ƒh                          
...
000000                        FL-STS1 " " FL-STS2 UPON CONSOLE.                  
000000                   STOP RUN .                                           
           DISPLAY "--Before --LINE:741--  CX00080" UPON CONSOLE
000000 CX00080.                                                                 
           DISPLAY "--After --LINE:743--  CX00080" UPON CONSOLE
000000     GO TO CX00078.                                                       
           DISPLAY "--Before --LINE:745--  CX00079" UPON CONSOLE
000000 CX00079.                                                                 
           DISPLAY "--After --LINE:747--  CX00079" UPON CONSOLE
000000                 DISPLAY "HBHUN551-35 VICHNURI READ ERROR " ,             
000000                        FL-STS1 " " FL-STS2 UPON CONSOLE.                  
000000                 STOP RUN .                                             
           DISPLAY "--Before --LINE:751--  CX00078" UPON CONSOLE
000000 CX00078.                                                                 
           DISPLAY "--After --LINE:753--  CX00078" UPON CONSOLE
000000     COMPUTE CNT-COMMIT = CNT-COMMIT + 1 .                                
000000     IF NOT(•Ï”‚b‚n‚l‚l‚h‚sŒ” < CNT-COMMIT) GO TO CX00081.                        
000000               COMMIT                                                     
000000     MOVE ZERO TO CNT-COMMIT .                                            
           DISPLAY "--Before --LINE:758--  CX00081" UPON CONSOLE
000000 CX00081.                                                                 
           DISPLAY "--After --LINE:760--  CX00081" UPON CONSOLE
...
000000     MOVE 0 TO ‚s—ÝŒv”„ã‹àŠz (‚b‚m‚s|”„ã‚s‚a‚k) .                                      
           DISPLAY "--Before --LINE:768--  CX00075" UPON CONSOLE
000000 CX00075.                                                                 
           DISPLAY "--After --LINE:770--  CX00075" UPON CONSOLE
000000     COMPUTE ‚b‚m‚s|”„ã‚s‚a‚k = ‚b‚m‚s|”„ã‚s‚a‚k + 1 .                                  
      *20141114’Ç‰ÁŠJŽn
...
000000     GO TO CX00073.                                                       
           DISPLAY "--Before --LINE:778--  CX00074" UPON CONSOLE
000000 CX00074.                                                                 
           DISPLAY "--After --LINE:780--  CX00074" UPON CONSOLE
000000 CX00008. EXIT.                                                           
000000 P300-RTN .                                                               
           DISPLAY "OUTPUT “ú•Ê”Ì”„‚b‚g•Ê”„ã—ÝŒv‚q" UPON CONSOLE
...
000000                      FL-STS1 " " FL-STS2 UPON CONSOLE.                    
000000         STOP RUN .                                                     
           DISPLAY "--Before --LINE:790--  CX00082" UPON CONSOLE
000000 CX00082.                                                                 
           DISPLAY "--After --LINE:792--  CX00082" UPON CONSOLE
000000     MOVE 1 TO ‚b‚m‚s|”„ã‚s‚a‚k                                                  
000000     MOVE 0 TO CNT-COMMIT .                                               
           DISPLAY "--Before --LINE:795--  CX00083" UPON CONSOLE
000000 CX00083. IF NOT( (‚b‚m‚s|”„ã‚s‚a‚k <= 
           ‚v‚j|”„ã‚s‚a‚k)) GO TO CX00084.                  
           DISPLAY "--After --LINE:798--  CX00083" UPON CONSOLE
...
000000     GO TO CX00086.                                                       
           DISPLAY "--Before --LINE:807--  CX00085" UPON CONSOLE
000000 CX00085.                                                                 
           DISPLAY "--After --LINE:809--  CX00085" UPON CONSOLE
...
000000           WRITE “ú•Ê”Ì”„‚b‚g•Ê”„ã—ÝŒv‚q INVALID CONTINUE.                           
           DISPLAY "WRITE “ú•Ê”Ì”„‚b‚g•Ê”„ã—ÝŒv‚q" UPON CONSOLE
000000     IF NOT(FL-STS1 NOT = "00") GO TO CX00087.                             
000000             DISPLAY "HBHUN551-37 VIHCHNUR WRITE ERROR " ,                
000000                          FL-STS1 " " FL-STS2 UPON CONSOLE.                
000000             STOP RUN .                                                 
           DISPLAY "--Before --LINE:825--  CX00087" UPON CONSOLE
000000 CX00087.                                                                 
           DISPLAY "--After --LINE:827--  CX00087" UPON CONSOLE
000000     COMPUTE CNT-COMMIT = CNT-COMMIT + 1 .                                
000000     IF NOT(•Ï”‚b‚n‚l‚l‚h‚sŒ” < CNT-COMMIT) GO TO CX00088.                        
000000             COMMIT                                                       
000000     MOVE 0 TO CNT-COMMIT .                                               
           DISPLAY "--Before --LINE:832--  CX00088" UPON CONSOLE
000000 CX00088.                                                                 
           DISPLAY "--After --LINE:834--  CX00088" UPON CONSOLE
           DISPLAY "--Before --LINE:835--  CX00086" UPON CONSOLE
000000 CX00086.                                                                 
           DISPLAY "--After --LINE:837--  CX00086" UPON CONSOLE
000000     COMPUTE ‚b‚m‚s|”„ã‚s‚a‚k = ‚b‚m‚s|”„ã‚s‚a‚k + 1 .                                  
      *20141114’Ç‰ÁŠJŽn
           IF ‚b‚m‚s|”„ã‚s‚a‚k > 1500
               MOVE 1 TO ‚b‚m‚s|”„ã‚s‚a‚k
...
000000     GO TO CX00083.                                                       
           DISPLAY "--Before --LINE:845--  CX00084" UPON CONSOLE
000000 CX00084.                                                                 
           DISPLAY "--After --LINE:847--  CX00084" UPON CONSOLE
000000 CX00009. EXIT.                                                           
